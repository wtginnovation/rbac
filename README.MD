...
#### OAuth2
There's also support for OAuth2/other provides via providing a `GrantedAuthoritiesMapper` (`RbacAuthoritiesMapper`). You'll just have to configure it in `WebSecurityConfigurerAdapter`. 
